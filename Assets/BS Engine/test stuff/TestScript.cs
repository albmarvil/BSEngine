...
public class TestScript : MonoBehaviour {
	...
	void Start () {
        ...
        DataTable data = new DataTable("dataTest", SerializationMode.BIN, true);
        ...
        //DataTable resultadosGlobales = new DataTable("Resultados", SerializationMode.BIN_XML, false);
        ...
        //StorageMgr.Singleton.SaveToFileAsync(resultadosGlobales, resultadosGlobales.Name);

        //StorageMgr.Singleton.SaveToFile(resultadosGlobales, "tacaYaComer");

        //StorageMgr.Singleton.SaveToFullPathFileAsync(resultadosGlobales, "C:/Users/tukar/Desktop", resultadosGlobales.Name);
